...
class _PrayerTimesState extends State<PrayerTimes> {
  ...
  Map data = {"الاسكندرية": "ALEXANDRIA", "القاهرة": "CAIRO"};
  @override
  void initState() {
              ...
              child: Row(
                ...
                children: [
                  ...
                  isLoading
                      ...
                      : Text(
                          monthPrayers[selectedDate.day - 1].HijDay +
                              " " +
                              monthPrayers[selectedDate.day - 1].HijMonth +
                              " " +
                              monthPrayers[selectedDate.day - 1].HijYear,
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              Icon(
                                ...
                                color: Color(0xFFD83D3A),
                              ),
                              Text("عشاء",
                                  style: (TextStyle(color: Color(0xFFD83D3A)))),
                              Text(monthPrayers[selectedDate.day - 1].Isha,
                                  style: (TextStyle(color: Color(0xFFD83D3A)))),
                            ],
                          ),
                          Spacer(),
                          Column(
                            children: [
                              ...
                              Text("مغرب",
                                  style: (TextStyle(color: Color(0xFFD83D3A)))),
                              Text(monthPrayers[selectedDate.day - 1].Maghrib,
                                  style: (TextStyle(color: Color(0xFFD83D3A)))),
                            ],
                          ),
                          Spacer(),
                          Column(
                            children: [
                              ...
                              Text("عصر",
                                  style: (TextStyle(color: Color(0xFFD83D3A)))),
                              Text(monthPrayers[selectedDate.day - 1].Asr,
                                  style: (TextStyle(color: Color(0xFFD83D3A)))),
                            ],
                          ),
                          Spacer(),
                          Column(
                            children: [
                              ...
                              Text("ظهر",
                                  style: (TextStyle(color: Color(0xFFD83D3A)))),
                              Text(monthPrayers[selectedDate.day - 1].Dhuhr,
                                  style: (TextStyle(color: Color(0xFFD83D3A)))),
                            ],
                          ),
                          Spacer(),
                          Column(
                            children: [
                              ...
                              Text("فجر",
                                  style: (TextStyle(color: Color(0xFFD83D3A)))),
                              Text(monthPrayers[selectedDate.day - 1].Fajr,
                                  style: (TextStyle(color: Color(0xFFD83D3A)))),
                            ],
                          ),
                          Spacer(),
                      ...
                      return Theme(
                        data: Theme.of(context).copyWith(
                          ...
                          colorScheme: ColorScheme.light(
                            ...
                            primary: Color(
                                0xFFD83D3A), // dialogue label bg and selected numbers
                            onPrimary: Colors.white, // on selected numbers
                            // surface: Colors.white,
                            onSurface: Colors.white, // days and months
                          ),
                          dialogBackgroundColor:
                              Colors.grey, // dialogue background
                          primaryColor: Color(
                              0xFFD83D3A), // header color and dialogue selected text
                      ...
                      child: InkWell(
                        ...
                        child: Row(
                          children: [
                            Spacer(),
                            Text(
                              monthPrayers[index].HijDay +
                                  " " +
                                  monthPrayers[index].HijMonth,
                              textDirection: TextDirection.rtl,
                            ...
                            Spacer(),
                            Text(monthPrayers[index].GregDate,
                                style:
  ...
  _fetchMonthPrayers() async {
    ...
    if (response.statusCode == 200) {
      ...
      testMap["data"].forEach((element) {
        ...
        var day = DayPrayers(
            element["timings"]["Fajr"],
            element["timings"]["Dhuhr"],
            element["timings"]["Asr"],
            element["timings"]["Maghrib"],
            element["timings"]["Isha"],
            element["date"]["hijri"]["weekday"]["ar"] +
                " " +
                element["date"]["hijri"]["day"],
            element["date"]["hijri"]["month"]["ar"],
            element["date"]["hijri"]["year"],
