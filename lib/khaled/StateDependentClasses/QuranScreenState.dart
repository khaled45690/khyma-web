...
class QuranScreenState {
  ...
  get() async {
    ...
    var response = await http.get(
      ...
      Uri.parse('https://elkhyma.com/ramadan/quraan.php?page=$pageNumber'),
      headers: <String, String>{
        'Content-Type': 'application/json',
      },
    );
    var response2 = await http.get(
      Uri.parse('https://elkhyma.com/ramadan/surahs.php'),
      headers: <String, String>{
        'Content-Type': 'application/json',
      },
    );
  ...
  surahSearch(int surahNumber) async {
    ...
    var response = await http.get(
      Uri.parse('https://elkhyma.com/ramadan/surah.php?page=$surahNumber'),
      headers: <String, String>{
        'Content-Type': 'application/json',
      },
    );
  ...
  changePage(int pageNumber) async {
    ...
    if (pageNumber >= 605 || pageNumber <= 0) {
      ...
      var response = await http.get(
        Uri.parse(
            'https://elkhyma.com/ramadan/quraan.php?page=$pageNumber'),
        headers: <String, String>{
          'Content-Type': 'application/json',
        },
      );
